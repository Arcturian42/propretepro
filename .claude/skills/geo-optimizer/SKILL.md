...
name: geo-optimizer
description: >-
  Make websites visible and citable by AI search engines (ChatGPT Search,
  Perplexity, Claude, Gemini AI Overviews). Use when the user wants to audit,
  improve, or monitor a site's GEO (Generative Engine Optimization) — robots.txt
  AI bot access, llms.txt, JSON-LD schema, citability, AI discovery endpoints,
  or wants to run `geo audit`/`geo fix`. Implements the GEO audit framework and a
  47-method citability engine based on Princeton KDD 2024 research.
---
